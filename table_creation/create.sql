...
GRANT SELECT ON HotelClient TO PUBLIC;
GRANT SELECT ON HotelBooking TO PUBLIC;
GRANT SELECT ON HotelHotel TO PUBLIC;
GRANT SELECT ON HotelRoom TO PUBLIC;
GRANT SELECT ON HotelAmenity TO PUBLIC;
GRANT SELECT ON HotelRating TO PUBLIC;
GRANT SELECT ON HotelEmployee TO PUBLIC;
GRANT SELECT ON HotelShift TO PUBLIC;
